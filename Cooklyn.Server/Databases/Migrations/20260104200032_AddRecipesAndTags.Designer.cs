...
namespace Cooklyn.Server.Databases.Migrations
{
    ...
    [Migration("20260104200032_AddRecipesAndTags")]
    partial class AddRecipesAndTags
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cooklyn.Server.Domain.Recipes.RecipeIngredient", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Unit", "Cooklyn.Server.Domain.Recipes.RecipeIngredient.Unit#UnitOfMeasure", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasIndex("SortOrder")
                        .HasDatabaseName("ix_recipe_ingredients_sort_order");
