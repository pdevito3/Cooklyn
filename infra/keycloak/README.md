...
Local development continues to use `Cooklyn.AppHost/keycloak/realm-export.json` with Keycloak's built-in `--import-realm` flag. This is simpler for local dev as URLs are static.
