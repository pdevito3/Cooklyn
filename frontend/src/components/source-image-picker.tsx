...
export function SourceImagePicker({
  ...
  const uploadImageFromUrl = useUploadRecipeImageFromUrl()
  ...
  const handleConfirm = () => {
    ...
    uploadImageFromUrl.mutate(
      { id: recipeId, imageUrl: selectedImageUrl },
      ...
      <SheetContent className="overflow-y-auto sm:max-w-lg">
        ...
        <SheetFooter>
          <Button
            ...
            disabled={!selectedImageUrl || uploadImageFromUrl.isPending}
          >
            {uploadImageFromUrl.isPending ? 'Uploading...' : 'Use This Image'}
          </Button>
        </SheetFooter>
      </SheetContent>
    </Sheet>
